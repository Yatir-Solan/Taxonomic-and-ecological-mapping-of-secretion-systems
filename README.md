...
- research_pipleine_scripts - the actual scripts to run the project. For a better understanding, follow the "[main.py](http://main.py/)" script, where other scripts and functions are called.
